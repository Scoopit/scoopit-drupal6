...
class ScoopIt {
	...
	public function topic($id, $curated=30, $curable=0, $page=0, $since = -1, $ncomments = 0) {
		return $this->get($this->scitServer."api/1/topic?id=".$id."&curated=".$curated."&curable=".$curable."&page=".$page."&since=".$since."&ncomments=".$ncomments)->topic;
	}
